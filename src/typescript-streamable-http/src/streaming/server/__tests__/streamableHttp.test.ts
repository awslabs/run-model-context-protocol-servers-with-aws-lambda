...
describe("SigV4StreamableHTTPServerTransport", () => {
    ...
    describe("Session Management", () => {
        ...
        it("should reject requests to uninitialized server", async () => {
            ...
            // Badric - changes to allow undefined session changes.
    ...
    describe("Request Handling", () => {
        ...
        it("should extract context from the x-context header", async () => {
            const contextObj = {
                testKey: 'testVal'
            }
            const notification: JSONRPCMessage = {
            ...
            const req = createMockRequest({
                ...
                headers: {
                    ...
                    "accept": "application/json, text/event-stream",
                    "mcp-session-id": transport.sessionId,
                    "x-context": JSON.stringify(contextObj),
                },
                body: JSON.stringify(notification),
            });
            ...
            expect(transport.getContext()).toStrictEqual(contextObj);
